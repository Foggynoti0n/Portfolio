      ...
      <div className="container mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="portfolio-item relative overflow-hidden rounded-lg transition-transform transform bg-gray-900 hover:bg-gray-800">
            <img className="w-full h-64 object-cover transition-transform transform hover:scale-110" src={wearfashion} alt="Project 1" />
            <div className="absolute inset-0 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity bg-black bg-opacity-60">
              <a className="text-white text-lg font-bold px-6 py-3 rounded-full bg-red-600 hover:bg-red-700 transition-colors" href="https://wearfashion.vercel.app/" data-lightbox="portfolio">View Project</a>
            </div>
          </div>
